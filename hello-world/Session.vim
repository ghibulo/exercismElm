...
silent only
cd ~/exercism2/elm/hello-world
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +0 tests/Tests.elm
badd +0 HelloWorld.elm
argglobal
silent! argdel *
...
setlocal path=~/exercism2/elm/hello-world/src,~/exercism2/elm/hello-world/elm-stuff/packages/**/src,.,/usr/include,,
