...
silent only
cd ~/exercism2/elm/word-count
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +0 WordCount.elm
badd +0 tests/Tests.elm
argglobal
silent! argdel *
$argadd WordCount.elm
...
setlocal path=~/exercism2/elm/word-count/src,~/exercism2/elm/word-count/elm-stuff/packages/**/src,.,/usr/include,,
...
silent! normal! zE
let s:l = 50 - ((32 * winheight(0) + 17) / 34)
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 30 - ((22 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
30
