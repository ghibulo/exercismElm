...
var author$project$WordCount$insertDict = F2(
	function (e, d) {
		return A3(
...
var author$project$WordCount$isNotPunctation = function (_char) {
	return !A2(
...
var author$project$WordCount$wordCount = function (sentence) {
	return A3(
		elm$core$List$foldl,
		author$project$WordCount$insertDict,
		elm$core$Dict$empty,
		elm$core$String$words(
			elm$core$String$toLower(
				A2(elm$core$String$filter, author$project$WordCount$isNotPunctation, sentence))));
};
		...
		[
			...
			function (_n0) {
				return A2(
					...
					_List_fromArray(
						[
							_Utils_Tuple2('word', 1)
						]),
					elm$core$Dict$toList(
						author$project$WordCount$wordCount('word')));
			}),
			A2(
			elm_explorations$test$Test$test,
			...
			function (_n1) {
				return A2(
					...
					_List_fromArray(
						[
							_Utils_Tuple2('each', 1),
							_Utils_Tuple2('of', 1),
							_Utils_Tuple2('one', 1)
						]),
					elm$core$Dict$toList(
						author$project$WordCount$wordCount('one of each')));
			}),
			A2(
			elm_explorations$test$Test$test,
				...
				return A2(
					...
					_List_fromArray(
						[
							...
							_Utils_Tuple2('fish', 4),
							_Utils_Tuple2('one', 1),
							_Utils_Tuple2('red', 1),
							_Utils_Tuple2('two', 1)
						]),
					elm$core$Dict$toList(
						author$project$WordCount$wordCount('one fish two fish red fish blue fish')));
			}),
			A2(
			elm_explorations$test$Test$test,
			'ignore punctuation',
				...
				return A2(
					...
					_List_fromArray(
						[
							_Utils_Tuple2('as', 1),
							_Utils_Tuple2('car', 1),
							_Utils_Tuple2('carpet', 1),
							_Utils_Tuple2('java', 1),
							_Utils_Tuple2('javascript', 1)
						]),
					elm$core$Dict$toList(
						author$project$WordCount$wordCount('car : carpet as java : javascript!!&@$%^&')));
			}),
			A2(
			elm_explorations$test$Test$test,
			'include numbers',
				...
				return A2(
					...
					_List_fromArray(
						[
							_Utils_Tuple2('1', 1),
							_Utils_Tuple2('2', 1),
							_Utils_Tuple2('testing', 2)
						]),
					elm$core$Dict$toList(
						author$project$WordCount$wordCount('testing, 1, 2 testing')));
			}),
			A2(
			elm_explorations$test$Test$test,
			'normalize case',
			function (_n5) {
				return A2(
					...
					_List_fromArray(
						[
							_Utils_Tuple2('go', 3),
							_Utils_Tuple2('stop', 2)
						]),
					elm$core$Dict$toList(
						author$project$WordCount$wordCount('go Go GO Stop stop')));
			})
		]));
...
var author$project$Test$Generated$Main2488404965$main = A2(
	author$project$Test$Runner$Node$run,
	{
		paths: _List_fromArray(
			['/home/ghibulo/exercism2/elm/word-count/tests/Tests.elm']),
		processes: 4,
		report: author$project$Test$Reporter$Reporter$ConsoleReport(author$project$Console$Text$UseColor),
		runs: elm$core$Maybe$Nothing,
		seed: 120413575127179
	},
...
_Platform_export({'Test':{'Generated':{'Main2488404965':{'init':author$project$Test$Generated$Main2488404965$main(elm$json$Json$Decode$int)(0)}}}});}(this));
return this.Elm;
})({});
var pipeFilename = "/tmp/elm_test-23025.sock";
