...
silent only
cd ~/exercism2/elm/collatz-conjecture
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +0 CollatzConjecture.elm
badd +0 tests/Tests.elm
argglobal
silent! argdel *
$argadd CollatzConjecture.elm
$argadd tests/Tests.elm
edit CollatzConjecture.elm
...
setlocal path=~/exercism2/elm/collatz-conjecture/src,~/exercism2/elm/collatz-conjecture/elm-stuff/packages/**/src,.,/usr/include,,
