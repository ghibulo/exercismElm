...
setlocal path=~/exercism2/elm/hamming/src,~/exercism2/elm/hamming/elm-stuff/packages/**/src,.,/usr/include,,
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 50 - ((31 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
50
