			...
			elm$core$List$length(
				A2(
					...
					A3(
						...
						elm$core$String$toList(right))))) : elm$core$Result$Err('left and right strands must be of equal length');
	});
...
var author$project$Test$Generated$Main1833774550$main = A2(
	author$project$Test$Runner$Node$run,
	{
		paths: _List_fromArray(
			['/home/ghibulo/exercism2/elm/hamming/tests/Tests.elm']),
		processes: 4,
		report: author$project$Test$Reporter$Reporter$ConsoleReport(author$project$Console$Text$UseColor),
		runs: elm$core$Maybe$Nothing,
		seed: 189634176474039
	},
...
_Platform_export({'Test':{'Generated':{'Main1833774550':{'init':author$project$Test$Generated$Main1833774550$main(elm$json$Json$Decode$int)(0)}}}});}(this));
return this.Elm;
})({});
var pipeFilename = "/tmp/elm_test-28558.sock";
